...
<div class="page-title">
              <div class="title_left">
                <h3>المجافظات <small>طنطاوى</small></h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                  <a href="{{route('admin.cities.create')}}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> اضافة محافظة جديد </a>
                  ...
                  <div class="x_content">
                    ...
                    <!-- start project list -->
                    <table class="table table-striped projects" id="citiesTable">
                      <thead>
                        <tr>
                        <th style="width: 1%"></th>
...
<script>
    $(document).ready(function() {
        ...
        var Cities_table = $('#citiesTable').DataTable({
            processing: true,
            serverSide: true,
            autoWidth: false,
            retrieve: true,
            ...
            ajax: {
                url: "{{route('admin.cities.index') }}", // call datatable data
                // data: function(d) {
