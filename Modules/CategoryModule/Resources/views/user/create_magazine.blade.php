                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group mx-sm-3 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="quantity" placeholder="1,2,3,4,..." name="inner_quantity">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group mx-sm-3 mb-2">
                                        <label for="quantity" class="sr-only">الكمية</label>
                                        <input type="text" name="quantity" class="form-control" id="quantity" placeholder="ادخل الكمية 1000 ومضاعفاتها">
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr id="div23" style="display: none;">
                                <td>
                                    <h3>الغلاف</h3>
                                </td>
                            </tr>
                            <tr id="div20" style="display: none;">
                                <td>نوع الغلاف :</td>
                                <td>
                            ...
                            <tr id="div21" style="display: none;">
                                <td>شكل الطباعة :</td>
                                <td>
                                    <select class="form-select" id="cover_selector" aria-label="Default select example" name="cover_print_option" onchange="show5();">
                                        <option selected>اختر</option>
                                        @foreach ($category->printOptions as $option)
                                        <option value="{{ $option->id }}">{{ $option->name }}</option>
                                        @endforeach
                            ...
                            <tr id="div22" style="display: none;">
                                <td>سلوفان :</td>
                                <td>
                                    <select class="form-select" aria-label="Default select example" name="covers">
                                        <option value="" selected>اختر</option>
                            ...
                            <tr id="div24" style="display: none;">

                                <td>ريجه :</td>
                                <td>
                                    <select class="form-select" aria-label="Default select example" name="cover_rega">
                                        <option value="" selected>اختر</option>
...
<script>
    ...
    function show7() {
        var x = document.getElementById("with_cover").value;
        if (x == '1') {
