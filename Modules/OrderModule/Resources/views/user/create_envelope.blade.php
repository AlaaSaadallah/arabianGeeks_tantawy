						...
						<tbody>
							<tr>
								...
								<td><select class="form-select" aria-label="Default select example">
										...
										<option value="DL (11*22)">DL (11*22) </option>
										<option value="C5 (22.9*16.2)">C5 (22.9*16.2) </option>
										<option value="C4 (22.9*32.4)">C4 (22.9*32.4) </option>
										<option value="C3 (32.4*45.7)">C3 (32.4*45.7) </option>
							...
							<tr>
								...
								<td>
									<select class="form-select" aria-label="Default select example">
										<option selected>اختر</option>
										<option value="100 gm">100 جم</option>
								...
								<td>
									<div class="form-group mx-sm-3 mb-2">
										...
										<input type="text" class="form-control" id="quantity"
											placeholder="ادخل الكمية 1000 ومضاعفاتها">
									</div>
								</td>
							</tr>
							<tr>
