        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <table class="table table-striped projects">
                    ...
                    <tbody>
                        <form method="post" action="{{route('admin.material.glue.update')}}">
                            @csrf
                        <tr>
                            <td>
                                <input type="hidden" name="id" value="{{$glue->id}}">
                                <input type="text" class="form-control" required="required" name="name"  value="{{$glue->name}}">
                            </td>
                            <td>
                                <input type="number" step="0.1" class="form-control" name="price" required="required" value="{{$glue->price}}">
                            </td>
                            <td>
