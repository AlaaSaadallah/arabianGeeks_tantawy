        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <table class="table table-striped projects">
                    ...
                    <tbody>
                        <form method="post" action="{{route('admin.material.finishDirections.update')}}">
                            @csrf
                        <tr>
                            <td>
                                <input type="hidden" name="id" value="{{$finishDirection->id}}">
                                <input type="text" class="form-control" required="required" name="name"  value="{{$finishDirection->name}}">
                            </td>
                            <!-- <td>
